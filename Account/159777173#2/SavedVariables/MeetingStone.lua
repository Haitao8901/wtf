...
MEETINGSTONE_UI_DB = {
	...
	["global"] = {
		["serverDatas"] = {
			...
			["ActivitiesData"] = {
				["data"] = "$1$Z$S277`魔兽主播活动`觉醒地下城`6月6日（周六）晚8点，快和斗鱼TV美女主播：近战之光喵妮莎（房间号：37625）一同为了艾泽拉斯而战*J上古之神恩佐斯，作为千须之魔，再次将魔爪指向艾泽拉斯，并且派遣着无面者们深入各地的巢穴，指挥着蛊心魔们控制着无数的生灵，勇士们，赶快协同斗鱼TV主播一起，将恩佐斯的爪牙一一铲除吧`http://w.163.com/special/convene-stone/`3`3$$",
			},
			["MallData"] = {
