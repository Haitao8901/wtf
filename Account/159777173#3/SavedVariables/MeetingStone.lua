...
MEETINGSTONE_UI_DB = {
	...
	["global"] = {
		["serverDatas"] = {
			...
			["ActivitiesData"] = {
				["data"] = "$1$Z$S284`魔兽主播活动`觉醒地下城`7月25日（周六）晚8点，快和斗鱼TV人气主播：痴汉万宝路（房间号：1340947）一同挑战史诗钥石地下城*J是潜入战火连天的伯拉勒斯阻止艾什凡女勋爵的阴谋，亦或是深入纳兹米尔的沼泽深处清除即将扩散到全世界的瘟疫，勇士们，赶快跟紧斗鱼TV主播的步伐，一同迎接全新的挑战吧`http://w.163.com/special/convene-stone/`2`3$$",
				["new"] = false,
			},
			["MallData"] = {
